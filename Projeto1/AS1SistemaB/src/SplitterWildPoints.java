...
public class SplitterWildPoints extends FilterFramework
{
    SplitterWildPoints(int numInputPort, int numOutputPorts)
    {
...
//                if is pressure
                if ( id == 3 )
                {
                    ...
                    if(Double.longBitsToDouble(measurement) < 50 || Double.longBitsToDouble(measurement) > 80){
                        ...
                        for(i = 0; i < 8; i++)
                        {
                            output = (byte)((timeMeasure >> ((7 - i) * 8)) & 0xff);
                            WriteFilterOutputPort(output,0);
                            byteswritten++;
                        } // for
                        ...
                        for(i = 0; i < 8; i++)
                        {
                            ...
                            WriteFilterOutputPort(output,0);
                            WriteFilterOutputPort(output,1);
                            byteswritten++;
                        } // for
                    }  // if
